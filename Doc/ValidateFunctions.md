...
| Функция | Назначение | Комментарий |
| - | - | - |
| LengthBetween | Ограничивает длину строк и коллекций | Можно ограничить длину сверху, снизу, сверху и снизу; значение NULL у границы приводит к ее игнорированию |
